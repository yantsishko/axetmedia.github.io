                ...
                <div class="box-body table-responsive">
                    <table id="projects" class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td><a href="/admin/article.php?id={$article.id}">{$article.name}</a></td>
                            <td>{$article.category}</td>
                            <td>
                                <a href="/admin/article.php?id={$article.id}"><i class="fa fa-pencil-square-o"></i></a>
                                <a  onclick="deleteArticle({$article.id});"><i class="fa fa-times"></i></a>
                            </td>
                        </tr>
                        {/foreach}
                        </tbody>
