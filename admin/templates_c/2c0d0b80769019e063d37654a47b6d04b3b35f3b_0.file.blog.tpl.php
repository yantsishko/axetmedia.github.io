<?php /* Smarty version 3.1.27, created on 2017-03-28 22:50:09
         compiled from "/Applications/MAMP/htdocs/axetgeneral_fin_start/admin/templates/blog.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:53240139858dabe71aa9735_90628178%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2c0d0b80769019e063d37654a47b6d04b3b35f3b' => 
    array (
      0 => '/Applications/MAMP/htdocs/axetgeneral_fin_start/admin/templates/blog.tpl',
      1 => 1490730606,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '53240139858dabe71aa9735_90628178',
  'variables' => 
  array (
    'articles' => 0,
    'article' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_58dabe71b34785_41125658',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_58dabe71b34785_41125658')) {
function content_58dabe71b34785_41125658 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '53240139858dabe71aa9735_90628178';
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="box">
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addArticle">Добавить статью</button>
...
?>
                        <tr>
                            <td><?php echo $_smarty_tpl->tpl_vars['article']->value['position'];?>
</td>
                            <td><a href="/admin/article.php?id=<?php echo $_smarty_tpl->tpl_vars['article']->value['id'];?>
"><?php echo $_smarty_tpl->tpl_vars['article']->value['name'];?>
</a></td>
                            <td><?php echo $_smarty_tpl->tpl_vars['article']->value['category'];?>
</td>
                            <td>
                                <a href="/admin/article.php?id=<?php echo $_smarty_tpl->tpl_vars['article']->value['id'];?>
"><i class="fa fa-pencil-square-o"></i></a>
                                <a  onclick="deleteArticle(<?php echo $_smarty_tpl->tpl_vars['article']->value['id'];?>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Новая статья</h4>
                </div>
...
?>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="createArticle();">Создать</button>
                </div>
            </div>
...
>
        ...
        function createArticle(){
            ...
            $.post( "controller.php",{ position: position, name: name, category:category, action:"addArticle"}, function( data ) {
                location.reload();
            });
        }

        function deleteArticle(articleId){
            var r = confirm("Удалить статью?");
            if (r == true) {
                $.post( "controller.php",{ id: articleId, action:"deleteArticle"}, function( data ) {
                    location.reload();
                });
            }
        }
