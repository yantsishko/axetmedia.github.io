...
<head>
    ...
    <!-- Meta Data -->
    <title>{$article.titleTeg}</title>
    <meta charset="utf-8" />
    <meta name="description" content="{$article.descrTeg}<" />
    ...
    <div class="container">
        ...
        <div class="row sectionIntro">
            ...
            <div class="col-md-12 col-md-offset-0 text-center">
                <h1><span data-scroll-reveal="enter left move 10px over 1s after 0.2s">{$article.name}</span></h1>
        ...
        <div class="row content">
            <div class="col-md-8 blog">
                ...
                <article>
                    ...
                    <div class="post-content">
                        <div class="thedate">{$article.createAt}</div>
                        <hr/>
                        {$article.descr}
                        <div id="share">
                            <div class="like">Понравилось? Поделитесь с друзьями!</div>
                            <div class="social" data-url="{$smarty.server.REQUEST_URI}" data-title="{$article.titleTeg}">
                ...
                <div class="author-wrap">
                    <div class="row">
                        <div class="col-sm-2">
                            <div class="author-gravatar"><img class="img-responsive " src="/img/autorAvatar.jpg" alt=""/></div>
                        </div>
                        <div class="col-sm-10">
                            <div class="author-info">
                                <div class="author author-title"><h6>Axet Media Expert</h6></div>
            ...
            <div class="col-md-4 blog">
                <div class="sidebar">
                    ...
                    <div class="widget">
                        <h3 class="badge">Недавние посты</h3>
                        <ul>
                            {foreach from=$articles item=article key=key}
                                <li><a href="/article.php?id={$article.id}">{$article.name}</a></li>
                            {/foreach}
                        </ul>
                    </div>
